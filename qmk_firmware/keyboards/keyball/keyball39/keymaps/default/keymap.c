...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    KC_ESC  ,  KC_LGUI  ,KC_LALT  ,KC_LCTL,  _______    , _______  ,      TO(2)    , TO(0) ,                                              KC_F12
  ),
  // 右移動＋マウスと左数字
  [2] = LAYOUT(
    KC_NUM_LOCK   , KC_KP_7     , KC_KP_8     , KC_KP_9     , KC_COMM  ,                            KC_PGUP  , KC_HOME  , KC_UP  , KC_END  , KC_PGDN  ,
    KC_LCTL, KC_KP_4     , KC_KP_5     , KC_KP_6     ,KC_DOT,                            LSFT(KC_9)  , KC_LEFT  , KC_DOWN    , KC_RGHT  , KC_ENT  ,
    KC_LSFT , KC_KP_1     , KC_KP_2     , KC_KP_3     ,KC_KP_0,                           KC_BTN3, KC_BTN1  , KC_BTN2  ,  _______ , KC_RSFT  ,
  ...
  [4] = LAYOUT(
    KC_F1    , KC_F2    , KC_F3    , KC_F4    , KC_F5    ,                            KC_7     , KC_8     , KC_9     , _______  , KC_BSPC  ,
    KC_LCTL  , KC_F6    , KC_F7    , KC_F8    , KC_F9    ,                            KC_4     , KC_5     , KC_6     , _______  , KC_ENT   ,
    KC_LSFT  , KC_F10   , KC_F11   , KC_F12   , _______  ,                            KC_1     , KC_2     , KC_3     , KC_0     , KC_RSFT  ,
